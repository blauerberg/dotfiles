return {
  ...
  keys = {
    ...
    -- Recently used files, persisted across sessions via v:oldfiles (shada).
    -- Unlike buffers, this lists files opened in past sessions too.
    { '<leader>fo', function() require('fzf-lua').oldfiles() end, desc = 'Recent files (oldfiles)' },
